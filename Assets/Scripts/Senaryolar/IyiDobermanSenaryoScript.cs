...
public class IyiDobermanSenaryoScript : MonoBehaviour
{
    ...
    [SerializeField] private Animator _human2Animator;
    [SerializeField] private Animator _human3Animator;
    //[SerializeField] private Animator _dobermanAnimator;
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.tag == "Player")
        {
            ...
            if (PlayerController._toplamBuyuDegeri >= _gerekliBuyuPuani)
            {
                ...
                _humanAnimator.SetBool("Victory", true);
                _human2Animator.SetBool("Victory", true);
                _human3Animator.SetBool("Victory", true);
