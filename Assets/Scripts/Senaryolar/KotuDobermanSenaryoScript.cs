...
public class KotuDobermanSenaryoScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //        _humanAnimator.SetBool("CageAktif", true);
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.tag == "Player")
        {
            ...
            if (PlayerController._toplamBuyuDegeri >= _gerekliBuyuPuani)
            {
                ...
                _humanAnimator.SetBool("Attack", true);
                _dobermanAnimator.SetBool("Attack", true);
